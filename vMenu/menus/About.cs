...
namespace vMenuClient
{
    public class About
    {
        ...
        private void CreateMenu()
        {
            ...
            MenuItem credits = new MenuItem("About vMenu / Credits", "vMenu is made by ~b~Vespura~s~. For more info, checkout ~b~www.vespura.com/vmenu~s~. Crappily modified by Matthew");
